 ...
 * @author TrieuNV
 */
public class DspComOrderPolModel extends AMDataPreprocessor implements Serializable {

    public List<DSPComOrderPol> getDSPComOrderPol(DSPComOrderPol dto, String table) throws Exception {
        List<DSPComOrderPol> listReturn = new ArrayList<>();
        ...
        try {
            ...
            while (mRs.next()) {
                DSPComOrderPol item = new DSPComOrderPol();
    ...
    public void insert(DSPComOrderPol dto, String table) throws Exception {
        try {
            open();
