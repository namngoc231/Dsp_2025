...
@Named
@ViewScoped
public class EduCodeController extends TSFuncTemplate implements Serializable {
    ...
    public EduCodeController() throws Exception {
    ...
    public void handleDeleteDcRequest(DSPDcDetail obj) {
        mtmpDcDetail = obj;
        mtmpDcDetail.setCardName(getCardTypeName(mtmpDcDetail.getPriceId()));
        mtmpDcDetail.setCardTypePrice(getCardTypePrice(mtmpDcDetail.getPriceId()));
    ...
    public void changeStateAddDcRequest() {
        isAddDetail = true;
        isEditDetail = false;
        mtmpDcDetail = new DSPDcDetail();
    ...
    public void changeStateEditDcRequest(DSPDcDetail obj) {
        isEditDetail = true;
        isAddDetail = false;
